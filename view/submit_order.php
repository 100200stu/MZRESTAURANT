...
// Proceed with the rest of the order submission logic if the cart is not empty
// You can replace the following with your original order submission code
$total = 0;
